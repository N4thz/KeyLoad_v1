 ...
 * @author cassi
 */
public class QRCodeGerador extends javax.swing.JDialog {
    ...
    public QRCodeGerador(JFrame QRCodeGerador, boolean par, String valor) {
        super(QRCodeGerador, "Senha em QR Code", true);
        ConteudoQRCode = valor;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QRCodeGerador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
    ...
    public String getConteudoQRCode(){
